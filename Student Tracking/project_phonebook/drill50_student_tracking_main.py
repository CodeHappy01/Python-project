...
import drill50_student_tracking_func
...
class ParentWindow(Frame):
    def __init__(self, master, *args, **kwargs):
        ...
        drill50_student_tracking_func.center_window(self,500,300)
        self.master.title("The Tkinter student_tracking Demo")
        self.master.configure(bg="#F0F0F0")
        # This protocol method is a tkinter built-in method to catch if 
        # the user clicks the upper corner, "X" on Windows OS.
        self.master.protocol("WM_DELETE_WINDOW", lambda: drill50_student_tracking_func.ask_quit(self))
        arg = self.master

        # load in the GUI widgets from a separate module, 
        # keeping your code comparmentalized and clutter free
        drill50_student_tracking_gui.load_gui(self)
        ...
        filemenu.add_command(label="Exit", underline=1,accelerator="Ctrl+Q",command=lambda: drill50_student_tracking_func.ask_quit(self))
        ...
        helpmenu.add_separator()
        helpmenu.add_command(label="About This student_tracking Demo") # add_command is a child menubar item of the add_cascde parent item
