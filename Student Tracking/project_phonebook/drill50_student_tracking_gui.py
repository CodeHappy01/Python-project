...
def load_gui(self):
    ...
    self.lbl_current_course.grid(row=6,column=0,padx=(27,0),pady=(10,0),sticky=N+W)
    ...
    self.txt_current_course.grid(row=7,column=0,rowspan=1,columnspan=2,padx=(30,40),pady=(0,0),sticky=N+E+W)
